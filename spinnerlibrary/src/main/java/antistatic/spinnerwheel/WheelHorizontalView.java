...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    protected void drawItems(Canvas canvas) {
        ...
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(leftOfLeftDivider + 30, 0, rightOfLeftDivider + 30, h);
            mSelectionDivider.draw(cSeparators);
            cSeparators.restore();
...
//            cSeparators.restore();
        ...
        //mViewAdapter.getItem(index, conve, mItemsLayout.getChildAt(0)).setBackgroundColor(Color.RED);
    ...
    public void setBackgroundView() {
        for (int i = 0; i < mItemsLayout.getChildCount(); i++) {
            if (i == mCurrentItemIdx) {
                mItemsLayout.getChildAt(mCurrentItemIdx).setBackgroundColor(Color.RED);
            } else {
